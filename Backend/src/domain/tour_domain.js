...
exports.TourDomain = void 0;
var tour_1 = require("../model/tour");
var TourDomain = /** @class */ (function () {
    function TourDomain() {
    }
    //get tour based on ui send limit of needed data
    TourDomain.prototype.getTour = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, tour_1.tourmodel.aggregate([
                                { $match: { rating: { $gte: 4 } } },
                                {
                                    $lookup: {
                                        from: 'images',
