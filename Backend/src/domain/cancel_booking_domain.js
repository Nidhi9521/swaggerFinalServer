            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        job1 = node_schedule_1.scheduledJobs["".concat(bookingId, "1")];
                        job2 = node_schedule_1.scheduledJobs["".concat(bookingId, "2")];
                        job3 = node_schedule_1.scheduledJobs["".concat(bookingId, "3")];
                        if (job1 != undefined) {
                            job1.cancel();
                        }
                        if (job2 != undefined) {
