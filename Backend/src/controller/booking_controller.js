...
var booking_domain_1 = require("../domain/booking_domain");
...
var BookingController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, bookIngDomain.addBooking(req, res)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bookIngDomain = new booking_domain_1.BookingDomain();
                        return [4 /*yield*/, bookIngDomain.roomBookAvailableCheck(req, res)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BookingController.userBookingHistory = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var bookIngDomain;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bookIngDomain = new booking_domain_1.BookingDomain();
                        return [4 /*yield*/, bookIngDomain.userBookingHistory(req, res)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BookingController.getRoomBookingPrize = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var bookIngDomain;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bookIngDomain = new booking_domain_1.BookingDomain();
                        return [4 /*yield*/, bookIngDomain.getRoomPrize(req, res)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BookingController.getAllBookingAdmin = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var bookIngDomain;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        bookIngDomain = new booking_domain_1.BookingDomain();
                        return [4 /*yield*/, bookIngDomain.getAllBookingAdmin(req, res)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
